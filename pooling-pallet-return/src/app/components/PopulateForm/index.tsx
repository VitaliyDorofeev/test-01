    ...
    <div>
      {loading ? (
        ...
        <div className='pallet-return-form__wrapper'>
          <div className="pallet-return-form__group__wrapper">
          ...
          <div className="contact">
            ...
            <form className="contact__form">
              <div className="contact__form__input-group">
                <input type="text" className="contact__form__input" placeholder='Название компании или ИНН'/>
                <input type="text" className="contact__form__input" placeholder='Фамилия, имя, Отчество'/>
                <input type="number" className="contact__form__input" placeholder='Телефон'/>
                <input type="text" className="contact__form__input" placeholder='E-mail'/>
              </div>
              <button onClick={sendForm} type='submit' className="contact__form__btn">Отправить заявку</button>
            </form>
            <div className="contact__desc">
              <span className='contact__desc__subtitle'>Заполняя форму, я принимаю <a href="#!" className='contact__desc__link'>условия</a> и даю <a href="#!" className='contact__desc__link'>согласие на обработку персональных данных.</a></span>
            </div>
          </div>
        </div>
      )}
